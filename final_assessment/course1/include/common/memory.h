...
/**
 * @brief move byte from source to destination
 *
 * This function takes 2 byte pointers (1 source and 1 destination) and a length
 * of bytes to move from the source location to the destination
 *
...
/**
 * @brief copy byte from source to destination
 *
 * This function takes 2 byte pointers (1 source and 1 destination) and a length
 ...
 * @param src Pointer to the source
 * @param length Length of bytes to move from source to destination
 * @param value Value to write in src
 *
...
/**
 * @brief set all locations of that memory to 0
 *
...
/**
 * @brief reverse order of all of the bytes
 *
...
/**
 * @brief allocate a number of words to dynamic memory
 *
